...
def read(configuration):
    ...
    for element in data:
        initial_position.append(int(element))
    return initial_position
#return np.reshape(initial_position,(3,3))
...
def solve(lin_eqn1,lin_eqn2):
	...
	vertex = (list(sym.linsolve([a1*x+b1*y+c1, a2*x+b2*y+c2], (x, y))))
	return vertex
